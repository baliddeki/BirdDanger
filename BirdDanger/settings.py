...
ALLOWED_HOSTS = os.getenv('DJANGO_ALLOWED_HOSTS', "localhost, 127.0.0.1:8000, nursing-emlynn-birddanger-af37826c.koyeb.app, birddanger.nursing-emlynn.internal:8000").split(',')
...
# Adjust database settings for production use, e.g., PostgreSQL
# DATABASES = {
#     'default': {
...
MEDIA_URL = '/media/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'voice_notes')
...
SECURE_CONTENT_TYPE_NOSNIFF = os.getenv('DJANGO_SECURE_CONTENT_TYPE_NOSNIFF', 'False') == 'True'
